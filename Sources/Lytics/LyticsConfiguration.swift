...
public struct LyticsConfiguration: Equatable {
    ...
    public var primaryIdentityKey = "_uid"

    /// The key which we use to store the anonymous identifier.
    public var anonymousIdentityKey = "_uid"
